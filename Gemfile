...
gem 'flare',                      '1.2.1',        github: 'shanti-uva/flare',                tag: 'v1.2.1' #path: '../flare'
gem 'interface_utils',            '2.3.7',        github: 'thl/interface_utils',             tag: 'v2.3.7' #path: '../../../thl/engines/interface_utils'
gem 'kmaps_engine',               '5.3.0',        github: 'shanti-uva/kmaps_engine',         tag: 'v5.3.0' #path: '../kmaps_engine'
gem 'resource_controller',        '0.9.2',        github: 'shanti-uva/resource_controller',  tag: 'v0.9.2' #path: '../resource_controller'
gem 'dictionary_to_terms',        '0.2.4',        github: 'shanti-uva/dictionary_to_terms',  tag: 'v0.2.4' #path: '../dictionary_to_terms'
